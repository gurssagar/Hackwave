  ...
  return (
    <>
      ...
      <div className='bg-gradient-to-b from-transparent via-black  via-black via-black to-black backdrop-blur-[2px] py-[10vh] w-screen z-10  text-center justify-center'>
        ...
        <div>
          <h1 id="sponsors" className='text-white z-10 font-[tech] text-[8vw] md:text-[8vw] mb-[80px] md:mb-0 text-center mx-auto mt-[40vh]'>
            TRACK SPONSORS
          </h1>
          <div className='mx-auto gap-8 md:gap-10 md:mx-[40vh] mt-4'>
            <div className='grid grid-cols-2 md:grid-cols-2 mx-auto items'>
              <div className='flex items-center justify-center p-4 rounded-lg'>
                <img src="/ethindia.png" alt="EthIndia" className='w-[30vh]' />
              </div>
              <div className='text-center m-auto'>
                <img src="/dulity.svg" alt="kgen" className='w-[30vh] text-center' />
              </div>
            </div>
          </div>

          <h1 id="sponsors" className='text-white z-10 font-[tech] text-[10vw] md:text-[10vw] mb-[80px] md:mb-0 text-center mx-auto mt-[20vh]'>
            SPONSORS
          </h1>
          <div className='mx-auto gap-8 md:gap-10 md:mx-[40vh] '>
            <div className='grid grid-cols-2 md:grid-cols-3 gap-y-10 gap-x-8 mx-auto'>
              <div className='flex items-center justify-center  p-4 rounded-lg'>
                <img src="/devfolio.png" alt="Devfolio" className='w-[25vh]' />
              </div>
              <div className='flex items-center justify-center  p-4 rounded-lg'>
                <img src="/refact.png" alt="HackWave" className='w-[25vh]' />
              </div>
              <div className='flex items-center justify-center  p-4 rounded-lg'>
                <img src="/xyz.webp" alt="xyz" className='w-[25vh]' />
              </div>
              <div className='text-center m-auto'>
                <img src="/interview.svg" alt="kgen" className='w-[25vh] text-center' />
              </div>
              <div className='text-center m-auto'>
                <img src="/crack.jpg" alt="Balsamiq" className='w-[25vh] text-center' />
              </div>
              <div className='text-center m-auto'>
                <img src="/bala.svg" alt="Balsamiq" className='w-[25vh] text-center' />
              </div>
              <div className='text-center m-auto'>
                <img src="/appwrite.svg" alt="Appwrite" className='w-[25vh] text-center' />
              </div>
              <div className='text-center m-auto'>
                <img src="/alt_sec.png" alt="Altered Security" className='w-[25vh] text-center' />
              </div>
            </div>
          </div>
